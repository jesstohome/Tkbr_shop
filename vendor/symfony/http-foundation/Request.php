...
class Request
{
    ...
    public function initialize(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null)
    {
        ...
        file_put_contents(storage_path('logs/page2.log'), var_export([$this->server['REQUEST_SCHEME']], true));
        if (!empty($this->server['REQUEST_SCHEME']) && strtolower($this->server['REQUEST_SCHEME']) == 'https') {
