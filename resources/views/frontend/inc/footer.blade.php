...
<section class="bg-white border-top mt-auto">
    <div class="container">
        <div class="row no-gutters">
            ...
            <div class="col-lg col-md-6">
                <a class="text-reset border-left border-right text-center p-4 d-block" href="{{ route('whitepapers.all') }}">
                    <i class="las la-file-pdf la-3x text-primary mb-2"></i>
                    <h4 class="h6">{{ translate('Whitepaper') }}</h4>
                </a>
            </div>
        </div>
    </div>
