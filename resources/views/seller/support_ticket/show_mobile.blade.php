...
<style>
    ...
    .seller-support-chat-mobile .newline {
        height: 38px;
        min-width: 38px;
        margin-left: 8px;
        padding: 0 6px;
            ...
            <div class="chat {{$ticketreply->user->id == Auth::id() ? 'mine' : ''}}" data-id="{{$ticketreply->id}}">
                ...
                @if($ticketreply->user->id == Auth::id())
                        <div class="btext">
                            ...
                            @if($ticketreply->reply)
                                <span class="bspan">@php $reply_text = empty($ticketreply->user_id) || -1 == $ticketreply->user_id ? translate($ticketreply->reply) : $ticketreply->reply; echo nl2br(e($reply_text)); @endphp</span> @endif
                ...
                @else
                        <div class="atext">
                            ...
                            @if($ticketreply->reply)
                                <span class="aspan">@php $reply_text = empty($ticketreply->user_id) || -1 == $ticketreply->user_id ? translate($ticketreply->reply) : $ticketreply->reply; echo nl2br(e($reply_text)); @endphp</span>@endif
                        </div>
                @endif
