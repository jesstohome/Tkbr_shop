                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div style="display: flex;justify-content: flex-end;">
                                            ...
                                            <a href="{{ is_android() ? 'javascript:void(0);' : route('invoice.download', $order->id) }}" class="btn btn-soft-warning btn-icon btn-circle btn-sm" title="{{ translate('Download Invoice') }}" @if (is_android()) onclick="downloadInvoicePdf('{{route('invoice.download', $order->id)}}');" @endif>
