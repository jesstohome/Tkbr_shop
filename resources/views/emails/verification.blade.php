                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{$message->embed('https://test.littleshopstudio.com/public/uploads/all/4WG0jrycWT21ivuYBHetMfBaWodBkv8hpMDPqTiy.png')}}" width="" height="24" border="0" alt="" /></td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; text-align:left; color:#2e57ae; padding-bottom:30px;">
                                                            ...
                                                            <p style='text-align: right'>Tiktok Shopping Technical Support</p>
                                                        </td>
                                                    </tr>
                                                    @if(!empty( $array['link']))
                                                    <tr>
