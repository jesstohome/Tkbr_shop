            ...
            <form action="{{ route('staffs.update', $staff->id) }}" method="POST">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Name')}}" id="name" name="name" value="{{ $staff->user->name }}" class="form-control" required @if(!(isSupperAdmin() || isBlocManage())) readonly @endif>
                        </div>
                    </div>
                    <div class="form-group row">
