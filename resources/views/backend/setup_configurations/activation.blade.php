...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header text-center bord-btm">
                <h3 class="mb-0 h6 text-center">{{translate('HT Payment Activation')}}</h3>
            </div>
            <div class="card-body">
                <div class="clearfix">
                    <label>{{translate('Collection on behalf')}}</label>
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'htpay_collection_behalf')" <?php if(get_setting('htpay_collection_behalf') == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="clearfix">
                    ...
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'htpay_payment_behalf')" <?php if(get_setting('htpay_payment_behalf') == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="alert text-center" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    {{ translate('You need to configure HT pay correctly to enable this feature') }}. <a href="{{ route('payment_method.index') }}">{{ translate('Configure Now') }}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header text-center bord-btm">
                <h3 class="mb-0 h6 text-center">印度{{translate('HT Payment Activation')}}</h3>
            </div>
            <div class="card-body">
                <div class="clearfix">
                    <label>{{translate('Collection on behalf')}}</label>
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'in_htpay_collection_behalf')" <?php if(get_setting('in_htpay_collection_behalf') == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="clearfix">
                    <label>{{translate('Payment on behalf')}}</label>
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'in_htpay_payment_behalf')" <?php if(get_setting('in_htpay_payment_behalf') == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="alert text-center" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header text-center bord-btm">
                <h3 class="mb-0 h6 text-center">{{translate('WINPAY Payment Activation')}}</h3>
            </div>
            <div class="card-body">
                <div class="clearfix">
                    <label>{{translate('Collection on behalf')}}</label>
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'winpay_collection_behalf')" <?php if(get_setting('winpay_collection_behalf') == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="clearfix">
                    <label>{{translate('Payment on behalf')}}</label>
                    <label class="aiz-switch aiz-switch-success mb-0 float-right">
                        <input type="checkbox" onchange="updateSettings(this, 'winpay_payment_behalf')" <?php if(get_setting('winpay_payment_behalf') == 1) echo "checked";?>>
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="alert text-center" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    {{ translate('You need to configure WINPAY correctly to enable this feature') }}. <a href="{{ route('payment_method.index') }}">{{ translate('Configure Now') }}</a>
                </div>
            </div>
        </div>
    </div>
