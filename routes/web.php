...
Route::get('/timedquery', [HomeController::class, 'timedquery'])->name('home.timedquery');
...
Route::get('/htpay/payment/notify', [HtPayController::class, 'notify'])->name('htpay.notify');
