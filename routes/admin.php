...
Route::get('/admin', [AdminController::class, 'admin_dashboard'])->name('admin.dashboard')->middleware(['auth', 'admin', 'unbanned', 'bloc_unbanned', 'ip_limited']);
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'unbanned', 'bloc_unbanned', 'ip_limited']], function () {
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/cashier_orders/product_review_detail_modal', 'product_review_detail_modal')->name('product_review_detail.show');
    ...
    Route::controller(SupportTicketController::class)->group(function () {
        ...
        Route::post('/support_ticket/remove_message', 'remove_message')->name('support_ticket.remove_message');
    });
