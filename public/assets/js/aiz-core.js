...
(function ($) {
    ...
    AIZ.uploader = {
        ...
        getAllUploads: function (url, search_key = null, sort_key = null, cb = null) {
        ...
        updateUploaderFiles: function () {
            ...
            setTimeout(function () {
                ...
                if (data.length > 0) {
                    ...
                    $(".aiz-uploader-all").html(
                        '<div class="align-items-center d-flex h-100 justify-content-center w-100 nav-tabs"><div class="text-center"><h3>' + AIZ.local.no_files_found + '</h3></div></div>'
                    );
                }
            ...
            $(".aiz-date-range").each(function () {
                ...
                $this.daterangepicker({
                    ...
                    locale: {
                        format: format,
                        separator: separator,
                        applyLabel: AIZ.local.daterangepicker && AIZ.local.daterangepicker.applyLabel || "Select",
                        cancelLabel: AIZ.local.daterangepicker && AIZ.local.daterangepicker.cancelLabel || "Clear",
                    },
                });
                if (single) {
        ...
        aizUppy: function () {
            if ($("#aiz-upload-files").length > 0) {
                ...
                uppy.on("upload-success", function (res) {
                    console.log('res=', res);
                    AIZ.uploader.getAllUploads(
                        AIZ.data.appUrl + "/aiz-uploader/get_uploaded_files", null, null, function () {
                            let value = AIZ.uploader.data.allFiles[0].id;
                            let valueObject = AIZ.uploader.data.allFiles[0];
                            AIZ.uploader.data.selectedFiles.push(value);
                            AIZ.uploader.data.selectedFilesObject.push(valueObject);
                        }
                    );
