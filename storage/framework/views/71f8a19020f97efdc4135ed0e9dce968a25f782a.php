            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <!--    <?php if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions))): ?>
                        ...
                        <?php if(Auth::user()->user_type == 'admin' || in_array('4', json_decode(Auth::user()->staff->role->permissions))): ?>
                             <li class="aiz-side-nav-item">
                                <a href="<?php echo e(route('clocking_orders.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['clocking_orders.index', 'clocking_orders.show'])); ?>" >
                                    <span class="aiz-side-nav-text"><?php echo e(translate('Clocking orders')); ?></span>  <!-- 预订订单  -->
                                </a>
                            </li>
                        <?php endif; ?>
...
<?php /**PATH D:\wamp64\www\alicrossborder.com\resources\views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>