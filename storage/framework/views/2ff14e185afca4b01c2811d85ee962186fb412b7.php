            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(translate('Order Type')); ?></th>
                        <th><?php echo e(translate('Time Left')); ?></th>
    ...
    <!--                    <td>
                        ...
                        <td>
                             <?php if($order->order_type == 6): ?>
                              <span class="badge badge-inline badge-danger"><?php echo e(translate('Urgent')); ?></span>
                             <?php elseif($order->order_type == 24): ?>
                              <?php echo e(translate('ordinary')); ?>
                        ...
                        <td>
                            <?php if($order->order_type == 6): ?>
                                <?php echo e(strtotime($order['created_at'].'+6 hours')-strtotime(date('Y-m-d H:i:s'))>0?date('H:i:s',strtotime($order['created_at'].'+6 hours')-strtotime(date('Y-m-d H:i:s'))):0); ?>

                            <?php else: ?>
                                <?php echo e(strtotime($order['created_at'].'+24 hours')-strtotime(date('Y-m-d H:i:s')) >0?date('H:i:s',strtotime($order['created_at'].'+24 hours')-strtotime(date('Y-m-d H:i:s'))):0); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/alicrossborder.com/resources/views/backend/sales/all_orders/index.blade.php ENDPATH**/ ?>