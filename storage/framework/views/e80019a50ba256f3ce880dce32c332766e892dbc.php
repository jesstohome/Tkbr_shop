        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            <div class="d-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-icon btn-circle btn-light" href="/" target="_blank" title="<?php echo e(translate('Browse Website')); ?>">
            ...
            <?php if(addon_is_activated('pos_system')): ?>
                <div class="d-flex justify-content-around align-items-center align-items-stretch ml-3">
                    <div class="aiz-topbar-item">
                        <div class="d-flex align-items-center">
                            <a class="btn btn-icon btn-circle btn-light" href="/salesman/pos" target="_blank" title="<?php echo e(translate('POS')); ?>">
...
<?php /**PATH /www/wwwroot/alicrossborder.com/resources/views/salesman/inc/salesman_nav.blade.php ENDPATH**/ ?>