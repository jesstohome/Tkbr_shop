...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        function offline_payment_approval(el){
            ...
            $.post('<?php echo e(route('salesman.offline_seller_package_payment.approved')); ?>', {_token:'<?php echo e(csrf_token()); ?>', id:el.value, status:status}, function(data){
                if(data == 1){
...
<?php echo $__env->make('salesman.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/alicrossborder.com/resources/views/manual_payment_methods/seller_package_payment_request_salesman.blade.php ENDPATH**/ ?>