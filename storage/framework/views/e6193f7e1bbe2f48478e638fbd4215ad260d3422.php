<div class="aiz-sidebar-wrap">
   ...
   <!--                     <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    <a href="<?php echo e(route('seller.creditscore_streams.index')); ?>"
                        class="aiz-side-nav-link <?php echo e(areActiveRoutes(['seller.creditscore_streams.index'])); ?>">
                        <i class="las la-history aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text"><?php echo e(translate('CreditscoreStream History')); ?></span>
                    </a>
                </li>
...
<script type="text/javascript">
  ...
  <?php endif; ?>
<?php /**PATH /www/wwwroot/alicrossborder.com/resources/views/seller/inc/seller_sidenav.blade.php ENDPATH**/ ?>