...
//        return ;
    ...
    public function getStates(Request $request) {
        ...
        foreach ($states as $state) {
            $selected = '';
            if (!empty($request->select_state_id)) {
                $selected = $request->select_state_id == $state->id ? 'selected' : '';
            }
    ...
    public function getCities(Request $request) {
        ...
        foreach ($cities as $row) {
            $selected = '';
            if (!empty($request->select_city_id)) {
                $selected = $request->select_city_id == $row->id ? 'selected' : '';
            }
