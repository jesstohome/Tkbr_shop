...
//            hlen_plus("audio:new_order_tip") > 0 ||
        ...
        echo json_encode( [
            ...
            'audio_new_shop_created_tip' => hlen_plus("audio:new_shop_created_tip") > 0,
            'audio_new_withdraw_tip' => hlen_plus("audio:new_withdraw_tip") > 0,
            'audio_new_conversation_tip' => hlen_plus("audio:new_conversation_tip") > 0 || hlen_plus("audio:new_pos_conversation_tip") > 0,
            'msg'=> 'Yes',
            'keys' => [
